...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/4smn/flexsearch.min.js');loadScript('/4smn/en.search-data.min.f73f9d8cd884db7499f5682b280482b824001479675725ea810b2caad88916a8.js',function(){input.required=false;search();});}
