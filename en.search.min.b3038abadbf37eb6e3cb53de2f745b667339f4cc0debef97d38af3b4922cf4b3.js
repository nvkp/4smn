...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/4smn/flexsearch.min.js');loadScript('/4smn/en.search-data.min.5257adba465a9cebb5256ac220dc4929727caca2fbf5a750fdb727f65225668a.js',function(){input.required=false;search();});}
