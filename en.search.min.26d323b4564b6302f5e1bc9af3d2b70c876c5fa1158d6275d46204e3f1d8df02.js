...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/4smn/flexsearch.min.js');loadScript('/4smn/en.search-data.min.5bc6eb6b68634e1d836d7cd78e1b7943d0751192769ecc43ae410b8e0ff58954.js',function(){input.required=false;search();});}
