...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/4smn/flexsearch.min.js');loadScript('/4smn/en.search-data.min.c2c006c1dd8d4415a87314af53d07cdded81c0feae14719f8208875de860e6fb.js',function(){input.required=false;search();});}
